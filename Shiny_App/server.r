...
function(input, output, session) {
  ...
  pop_evo_A = reactive({
    evo_apart(input$ratio, input$vHH, input$vHL, input$vLH, input$vLL, input$K, input$time)[[1]]
  })
  
  pay_evo_A = reactive({
    evo_apart(input$ratio, input$vHH, input$vHL, input$vLH, input$vLL, input$K, input$time)[[2]]
  })
  
  group_evo_A = reactive({
    evo_apart(input$ratio, input$vHH, input$vHL, input$vLH, input$vLL, input$K, input$time)[[3]]
  })
